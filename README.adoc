...
Matriz vigente: https://portal.ifto.edu.br/ifto/colegiados/consup/documentos-aprovados/ppc/campus-palmas/tecnologia-em-sistemas-para-internet/ppc-superior-de-tecnologia-em-sistemas-para-internet-campus-palmas-ifto.pdf/@@download/file/grade-curricular-tecnologia-em-sistemas-para-internet.pdf[Grade Curricular] convalidada pela Resolução CONSUP/IFTO N.º 212, de 18 de abril de 2023. Aplicada aos estudantes ingressantes a partir de 2023/1.
