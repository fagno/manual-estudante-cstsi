...
=== Horário Turmas 2022/2

Acesse o horário de aulas do CST em Sistemas para Internet no semestre 2021/2.

https://drive.google.com/file/d/1cD5QLHsAMMcsXVUtu0Rph8nImbTeRf5y/view?usp=sharing[Horário Turno Matutino]

https://drive.google.com/file/d/1_LrHYl_bFFvxxdN1t9ZOjr007lkx6pUg/view?usp=sharing[Horário Turno Noturno]
...
// - Infraestrutura para Sistemas Web (MATUTINO): bxtilrw 

// - Infraestrutura para Sistemas Web (NOTURNO): xdeqnel 

// |Ana Paula Guimarães| 

// - Programação para Dispositivos Móveis I (NOTURNO): beizvo5

// - Programação para Dispositivos Móveis II (MATUTINO): qf5vg4r

// - Programação para Dispositivos Móveis II (NOTURNO): dcsxdbd 
