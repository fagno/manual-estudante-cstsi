...
Para ter acesso aos horários de cada professor do campus, acesse o link: https://ifto.edupage.org/timetable/

=== Calendário Acadêmico 2024

Neste link você encontra os https://portal.ifto.edu.br/palmas/centrais-de-conteudos/documentos/calendarios-academicos/calendarios-academicos-2024-1/calendario-superior-2024-alterado-pos-greve.pdf/view [calendários acadêmicos] dos cursos do Campus Palmas.
