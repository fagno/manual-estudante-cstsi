...
https://drive.google.com/file/d/19lMMAiIm7WqCYWRTRmTtb1RbJdXfhMsl/view?usp=sharing[Horário Turno Noturno]

=== Código de Turmas Google Classroom

A seguir é apresentado o código das turmas das disciplinas dos professores que utilizam o classroom.

|===
|*PROFESSOR*| *DISCIPLINAS E CÓDIGOS*
|Cláudio Monteiro| 
- Introdução à Conectividade (MATUTINO): lukcfyd

- Tendências Tecnológicas para o MercadO de TI (MATUTINO): d22lzq6

|Napoleao Ribeiro| 
- Fundamentos de Redes de Computadores (MATUTINO): i65j44k 

- Introdução à Computação (MATUTINO): nweueuz
...
- Programação para Dispositivos Móveis I (NOTURNO): koili6w

- Programação para Dispositivos Móveis II (MATUTINO): 3y6737b 

- Programação para Dispositivos Móveis II (NOTURNO): m7aasfs 

- Programação Orientada a Objetos (MATUTINO): nkwwssf

|Marlio Kleber| 

- Projeto de Interface Web (MATUTINO): oprj5f3

- Projeto de Interface Web (NOTURNO): 7hsp3k3
